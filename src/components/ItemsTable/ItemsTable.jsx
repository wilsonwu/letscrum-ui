...
import { Row, Form, Table, Dropdown, CloseButton, Stack } from 'react-bootstrap';
    ...
    <>
      ...
      >
        <Form.Control
          ...
          size="sm"
        />
        <Dropdown className='mx-1 filterDropdown ms-auto'>
        ...
        <CloseButton className='pe-3 filterDropdown'/>
      </Stack>
      {/* table */}
      <Row className='px-2'>
